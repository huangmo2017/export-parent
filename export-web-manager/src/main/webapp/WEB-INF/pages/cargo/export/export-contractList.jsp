                    ...
                    <div class="pull-left">
                        <div class="form-group form-inline">
                            <div class="btn-group">
                                ...
                                <button type="button" class="btn btn-default" title="打印" onclick='deleteById()'><i
                                        class="fa fa-print"></i> 打印
                                </button>
                                <button type="button" class="btn btn-default" title="报运"
                                        onclick="document.getElementById('exportForm').submit()"><i
                                        class="fa fa-refresh"></i> 报运
                                </button>
                            </div>
                        </div>
                    </div>
